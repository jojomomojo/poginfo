...
import (
	...
	"github.com/jojomomojo/poginfo/pkg/api"
	"github.com/jojomomojo/poginfo/pkg/grpc"
	"github.com/jojomomojo/poginfo/pkg/signals"
	"github.com/jojomomojo/poginfo/pkg/version"
)
...
func main() {
	...
	fs.String("grpc-service-name", "poginfo", "gPRC service name")
	...
	fs.String("ui-message", fmt.Sprintf("greetings from poginfo v%v", version.VERSION), "UI message")
	...
	viper.SetDefault("ui-logo", "https://raw.githubusercontent.com/jojomomojo/poginfo/gh-pages/cuddle_clap.gif")
